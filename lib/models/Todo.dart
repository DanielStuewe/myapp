...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, required name, description, deadline, state, createdAt, updatedAt}): _name = name, _description = description, _deadline = deadline, _state = state, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String name, String? description, amplify_core.TemporalDateTime? deadline, TodoState? state}) {
  ...
  Todo copyWith({String? name, String? description, amplify_core.TemporalDateTime? deadline, TodoState? state}) {
    return Todo._internal(
      id: id,
      name: name ?? this.name,
  ...
  Todo copyWithModelFieldValues({
    ...
    ModelFieldValue<TodoState?>? state
  }) {
    return Todo._internal(
      id: id,
  ...
  Todo.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _state = amplify_core.enumFromString<TodoState>(json['state'], TodoState.values),
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'deadline': _deadline?.format(), 'state': amplify_core.enumToString(_state), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
